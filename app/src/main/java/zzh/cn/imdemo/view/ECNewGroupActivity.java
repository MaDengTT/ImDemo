...
public class ECNewGroupActivity extends EaseBaseActivity {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        String reason = ECNewGroupActivity.this.getString(R.string.invite_join_group);
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                progressDialog.dismiss();
                                Toast.makeText(ECNewGroupActivity.this, st2 + e.getLocalizedMessage(), Toast.LENGTH_LONG).show();
                            }
                        });
                    }
